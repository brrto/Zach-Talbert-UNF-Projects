...
function Upgrade2() {
    ...
    this.position = createVector(width-this.size.x-15, height-this.size.y-15);
    this.upgradeColor = 0;
    ...
    this.increment = function() {
        if (this.upgrade<100 && character2.gunType==="burstShot")
            this.upgrade += 4;
//        if (this.upgrade<100 && character2.gunType==="shotgun")
//            this.upgrade += 4;
//        if (this.upgrade<100 && character2.gunType==="sniper")
//            this.upgrade += 4;
//        if (this.upgrade<100 && character2.gunType==="laser")
//            this.upgrade += 10;
    }
